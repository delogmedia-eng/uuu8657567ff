...
// هنستخدم إصدار node-fetch المتوافق عشان كودك القديم يشتغل زي الباشا
...
app.use(cors({
    origin: '*', // بيسمح لأي موقع يكلمه
    methods: ['POST', 'GET', 'OPTIONS'],
    allowedHeaders: ['Content-Type', 'Authorization']
}));
app.use(express.json());

// التعديل الأول: خليناها WEBHOOK_URL عشان تقرأ من Railway صح
